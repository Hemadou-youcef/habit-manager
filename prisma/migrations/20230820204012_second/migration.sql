...
*/
-- DropForeignKey
ALTER TABLE `habits` DROP FOREIGN KEY `Habits_userId_fkey`;

-- DropForeignKey
ALTER TABLE `habitsgroup` DROP FOREIGN KEY `HabitsGroup_userId_fkey`;

-- AlterTable
ALTER TABLE `habits` MODIFY `userId` VARCHAR(191) NOT NULL;

-- AlterTable
ALTER TABLE `habitsgroup` MODIFY `userId` VARCHAR(191) NOT NULL;
